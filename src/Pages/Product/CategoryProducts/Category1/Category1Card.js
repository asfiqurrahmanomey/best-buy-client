...
const Category1Card = ({ category1, setBooking }) => {
    const { _id, title, seller, published_date, rating, name, image_url, current_price, selling_price, location, used } = category1;
    return (
        <div>
            <div className="">
                {/* Remove py-8 */}
                            ...
                            <div className="bg-white">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex justify-between mt-4">
                                        ...
                                        <div className="pl-2">
                                            <label onClick={() => setBooking(category1)}
