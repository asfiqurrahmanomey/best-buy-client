...
const AddedProductCard = ({ addProducts, setBooking }) => {
    const { _id, title, seller, published_date, rating, name, image, current_price, selling_Price, location, used } = addProducts;
    return (
        <div>
            <div className="">
                {/* Remove py-8 */}
                            ...
                            <div className="bg-white">
                                <div className="flex items-center justify-between px-4 pt-4">
                                    <div className='flex'>
                                        ...
                                        <p className='text-sm ml-2 font-semibold text-indigo-700'>{name}</p>
                                    </div>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex justify-between mt-4">
                                        ...
                                        <div className="pl-2">
                                            <label onClick={() => setBooking(addProducts)}
