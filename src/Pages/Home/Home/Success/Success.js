                            ...
                            <div className="px-4 py-6">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-1.5 text-lg font-medium leading-tight text-white">Team members</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="px-4 py-6">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-1.5 text-lg font-medium leading-tight text-white">Customer success</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-10 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 gap-x-16 xl:gap-x-24">
                        <div className="relative mb-6" data-aos="zoom-in-right" data-aos-duration="3000">
                            <img className="w-full rounded-md" src="https://i.ibb.co/tZWZdtX/Best-Smartphones-Under-50000-in-Nepal.jpg" alt="" />

                            <div className="absolute w-full max-w-xs px-4 -translate-x-1/2 sm:px-0 sm:max-w-sm left-1/2 -bottom-12">
                                <div className="overflow-hidden bg-white rounded">
                                    <div className="px-10 py-6">
                                        <div className="flex items-center">
                                            <p className="flex-shrink-0 text-3xl font-bold text-orange-600 sm:text-4xl">50%</p>
                                            <p className="pl-6 text-sm font-medium text-black sm:text-lg">Low Price Then <br />Local Shops</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
