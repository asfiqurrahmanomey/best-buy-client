    ...
    return (
        <div>
            <div className="2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 px-4 py-9 ">
                <h1 className=" text-center lg:mb-20 mb-10 text-orange-600 font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 w-9/12 md:w-full mx-auto">Hear From Our Sellers</h1>
                            ...
                            >
                                <SwiperSlide style={{ width: "100% !important" }}>
                                    <div className="w-72 flex-none">
                                        <div className="w-full">
                                            <div className="mb-6">
                                                <p className='text-lg font-bold '>Andrea Drew</p>
                                            </div>
                                ...
                                <SwiperSlide style={{ width: "100% !important" }}>
                                    <div className=" w-72 flex-none ">
                                        <div className=" w-full">
                                            <div className="mb-6">
                                            <p className='text-xl font-bold '>Andrea Drew</p>
                                            </div>
